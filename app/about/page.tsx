...
export const metadata: Metadata = {
  title: "About Us",
  description: "Learn about Flywik, your trusted wholesale tech partner.",
};
    ...
    <div className="bg-white">
      <section className="bg-gradient-to-r from-gray-900 to-lime-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-3xl font-bold">About Flywik</h1>
          <p className="text-gray-300 mt-1">Your trusted tech partner since 2020</p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="space-y-3 text-gray-600">
                <p>Flywik was founded in 2020 in Lisbon with one goal: make quality tech accessible at fair prices.</p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="p-5 bg-lime-50 rounded-xl text-center">
                  <div className="text-2xl font-bold text-lime-600">{s.n}</div>
      ...
      <section className="py-14">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="space-y-4">
            {[
              { y: "2020", t: "Founded in Lisbon" },
              { y: "2021", t: "Expanded into audio products" },
              { y: "2022", t: "Launched international shipping" },
              { y: "2023", t: "Reached 500+ customers" },
              { y: "2025", t: "2,600+ products in catalogue" },
            ].map((m, i) => (
              <div key={i} className="flex gap-4 items-center">
                <span className="text-lime-600 font-bold w-14">{m.y}</span>
      ...
      <section className="bg-lime-600 py-12">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold text-white mb-3">Work with Us</h2>
          <p className="text-lime-100 mb-5">Join our network of satisfied customers</p>
          <Link href="/contact" className="px-6 py-2.5 bg-white text-lime-600 font-medium rounded-lg hover:bg-lime-50">
            Get in Touch
          </Link>
        </div>
      </section>
